...
export default function ArticleHighlights({ items }: ArticleHighlightsProps) {
  ...
  return (
    <div className="bg-brand/[0.08] border border-brand/30 rounded-xl p-5 md:p-6 mb-8 md:mb-10">
      ...
      <ul className="space-y-2.5">
        {items.map((item, i) => (
          <li key={i} className="flex items-start gap-2.5 text-sm md:text-[15px] text-zinc-400 leading-relaxed">
