    ...
    <div className="urban-rich-text font-serif">
      <div
        className="
          ...
          prose-blockquote:border-l-brand prose-blockquote:italic prose-blockquote:bg-gray-50 dark:prose-blockquote:bg-zinc-800/50 prose-blockquote:rounded-r-lg
      ...
      {secondaryImage && (
        <figure className="w-full md:w-80 float-right md:ml-6 md:mb-4 space-y-1 hidden md:block mt-6 md:mt-0">
          ...
          {secondaryImageCaption && (
            <p className="text-right text-fg-subtle text-xs italic">{secondaryImageCaption}</p>
          )}
        </figure>
      )}
    </div>
