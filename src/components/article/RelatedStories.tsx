...
export default function RelatedStories({ article, related }: RelatedStoriesProps) {
  ...
  return (
    <section className="mt-12 md:mt-16 pt-8 md:pt-10 border-t border-gray-200 dark:border-zinc-800">
      <div className="flex items-center justify-between mb-6 md:mb-8">
        <div className="flex items-center gap-3">
          <div className="w-1 h-6 md:h-7 bg-brand rounded-full" />
          <h2 className="text-xl md:text-2xl lg:text-3xl font-black text-gray-900 dark:text-white font-headline">
            Related Stories
          </h2>
        </div>
        <Link
