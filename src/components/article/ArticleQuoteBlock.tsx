  ...
  return (
    <figure className="my-8 md:my-10 mx-0">
      <div className="relative bg-gray-50 dark:bg-zinc-800/40 rounded-xl border-l-[4px] border-brand p-5 md:p-7">
        ...
        <blockquote className="text-lg md:text-xl lg:text-2xl font-medium text-fg italic leading-[1.7] md:leading-[1.8] pl-10 md:pl-12">
          {text}
        </blockquote>
        {author && (
          <figcaption className="mt-3 pl-10 md:pl-12 text-sm font-semibold text-fg-subtle">
            — {author}
          </figcaption>
        )}
      </div>
