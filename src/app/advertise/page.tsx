    ...
    <div className="w-full max-w-screen-xl mx-auto px-4 md:px-6 py-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-14">
        {benefits.map((b) => {
          const Icon = b.icon;
          return (
            <div key={b.title} className="bg-zinc-900 rounded-xl border border-zinc-800 p-6">
      ...
      {/* Ad Formats */}
      <h2 className="text-2xl font-black text-white text-center mb-8">Available Ad Formats</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-14">
        {adFormats.map((format) => (
          <div key={format.title} className="bg-zinc-900 rounded-xl border border-zinc-800 p-6">
      ...
      <div className="bg-gradient-to-br from-brand/10 to-blue-500/10 rounded-2xl border border-brand/20 p-8 md:p-10 text-center">
        <h2 className="text-2xl font-black text-white mb-3">Ready to Reach Africa?</h2>
